...
public class Workshop1UI extends JFrame {
	...
	private class ImagePanel extends JPanel implements MouseListener, ActionListener, MouseMotionListener {
		...
		private void showPopup(MouseEvent e) {
			...
			JMenuItem getIntensityValueMenuItem = new JMenuItem("getIntensityValue");
			...
			JMenuItem saveThisPointMenuItem = new JMenuItem("saveThisPoint");
			saveThisPointMenuItem.addActionListener(this);
			saveThisPointMenuItem.setActionCommand("saveThisPoint");
			viewportPopup.add(saveThisPointMenuItem);
			
			JMenuItem getD4DistanceMenuItem = new JMenuItem("getD4Distance");
			...
			JMenuItem setShortestMPathToWhiteMenuItem = new JMenuItem("setShortestMPathToWhite");
		...
		public void actionPerformed(ActionEvent e) {
			...
			} else if (e.getActionCommand().equals("saveThisPoint")) {
				if (img!= null) {
					otherColumn = column;
					otherRow = row;
				}
